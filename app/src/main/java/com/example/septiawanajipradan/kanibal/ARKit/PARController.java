...
import com.example.septiawanajipradan.kanibal.sensorkit.PSKEventListener;
import com.example.septiawanajipradan.kanibal.sensorkit.PSKSensorManager;
...
implements PSKEventListener {
    ...
    public void init(Context ctx, String apiKey) {
        ...
        dataCollector.addEntry(new BasicNameValuePair(URLEncoder.encode("entry.355335633"), URLEncoder.encode(deviceId)));
        dataCollector.addEntry(new BasicNameValuePair(URLEncoder.encode("entry.990059982"), URLEncoder.encode(osVersion)));
    ...
    extends AsyncTask {
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            try {
                try {
                    HttpResponse execute = client.execute((HttpUriRequest)httpGet);
