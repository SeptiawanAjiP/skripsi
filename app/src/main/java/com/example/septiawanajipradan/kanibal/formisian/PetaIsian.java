package com.example.septiawanajipradan.kanibal.formisian;
...
import com.example.septiawanajipradan.kanibal.helper.GPSTracker;
...
public class PetaIsian extends FragmentActivity implements GoogleMap.OnInfoWindowClickListener,OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        mMap.setInfoWindowAdapter(new TagTempatInfoWindow(PetaIsian.this));
