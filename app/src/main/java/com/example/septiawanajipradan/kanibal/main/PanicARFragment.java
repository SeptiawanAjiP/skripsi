...
import com.example.septiawanajipradan.kanibal.ARKit.PARController;
import com.example.septiawanajipradan.kanibal.ARKit.PARFragment;
import com.example.septiawanajipradan.kanibal.ARKit.PARPoiLabel;
import com.example.septiawanajipradan.kanibal.ARKit.PARPoiLabelAdvanced;
...
import com.example.septiawanajipradan.kanibal.sensorkit.PSKDeviceAttitude;
        ...
        if(bangunanSensusArrayList!= null){
            for(int i=0;i<bangunanSensusArrayList.size();i++){
                PARController.getInstance().addPoi(createPoi(bangunanSensusArrayList.get(i).getNamaKRT(),bangunanSensusArrayList.get(i).getPathFoto(),
                        bangunanSensusArrayList.get(i).getLat(),bangunanSensusArrayList.get(i).getLon()));
            }
        }else{
